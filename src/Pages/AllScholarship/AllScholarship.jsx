...
//         queryFn: async () => {
//             const res = await axiosPublic.get(`/scholarship?search=${searchValue}&page=${currentPage}&limit=${limit}`)
//             return res.data
//         }
//     })
//     console.log(data)
//     const numberOfPages = Math.ceil(data?.totalitems / limit)
...
//                 {data?.result?.length ? <div className="w-10/12 mx-auto">
//                     <div className=" grid md:grid-cols-2 lg:grid-cols-3">
//                         {
//                             data?.result?.map(scholarship => <ScholarshipCart key={scholarship._id} data={scholarship}></ScholarshipCart>)
//                         }
//                     </div>
...
//                             className={`border py-1 px-3 rounded-md ml-2  ${currentPage == page && "selectedBtn"}`}
//                             key={page}>{page}
//                         </button>)}
//                     </div>
//                 </div> :
